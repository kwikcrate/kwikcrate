...
import mobaTopUps from '../data/mobaTopUps';
...
const Moba5v5 = () => {
  ...
  const handleValidation = () => {
    if (uid.trim() === "") {
      alert("Please enter a valid Moba 5v5 UID.");
      return;
    }
    alert(`Moba 5v5 UID ${uid} validated successfully.`);
  };
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `url(${mobaBanner})` }}
    >
      <div className="max-w-3xl mx-auto bg-zinc-900 bg-opacity-90 text-white rounded-xl p-6 shadow-xl">
        <h1 className="text-3xl font-bold mb-4 text-center">Moba 5v5 Top-Up</h1>

        <div className="mb-6 text-sm text-gray-300">
          <p><strong>Where to find your Moba 5v5 UID?</strong></p>
          <p>Launch game → Profile → Your UID is visible near the player info section.</p>
        </div>

        <div className="mb-4">
          <input
            type="text"
            placeholder="Enter Moba 5v5 UID"
